...
valid_email="nabingyawali2459@gmail.com"
...
time.sleep(2)
loginbtn1=driver.find_element(By.XPATH,value='/html/body/div[1]/div[2]/div/a[1]/div/span')
az.ActionChains(driver).click(loginbtn1).perform()

emailinput=driver.find_element(By.XPATH,value='/html/body/div[1]/div[1]/div/main/div/div[2]/div/div[2]/div/form/div/div[2]/div/div/div[1]/div[2]/input')
emailinput.send_keys(valid_email)
passwordinput=driver.find_element(By.XPATH,value='/html/body/div[1]/div[1]/div/main/div/div[2]/div/div[2]/div/form/div/div[3]/div/div/div[1]/div[2]/input')
passwordinput.send_keys(valid_password)
storelogin=driver.find_element(By.XPATH,value='//*[@id="app"]/div/div/main/div/div[2]/div/div[2]/div/form/div/div[4]/button/span')
...
time.sleep(3)
loggeduser=driver.find_element(By.XPATH,value='//*[@id="app"]/div/div/nav/div[1]/div/div[1]/div[2]/div[2]').text
